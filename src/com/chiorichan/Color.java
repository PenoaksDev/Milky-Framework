...
/**
 * A container for a color palette. This class is immutable; the set methods return a new color. The color names listed
 * as fields are HTML4 standards, but subject to change.
 */
...
public final class Color implements ConfigurationSerializable
{
	...
	/**
	 * Creates a new color object from an integer that contains the red, green, and blue bytes in the lowest order 24
	 * bits.
	 * 
	 * @param rgb
	...
	/**
	 * Creates a new color object from an integer that contains the blue, green, and red bytes in the lowest order 24
	 * bits.
	 * 
	 * @param bgr
