...
public class DLUpdaterService
{
	...
	public DLUpdaterService(String host)
	{
		this.host = host;
	}
	...
	public ArtifactDetails getArtifact( String slug, String name )
	{
		...
		{
			Logger.getLogger( DLUpdaterService.class.getName() ).log( Level.WARNING, "Could not get " + name + ": " + ex.getClass().getSimpleName() );
		}
	...
	{
		return "CraftBukkit/" + DLUpdaterService.class.getPackage().getImplementationVersion() + "/" + System.getProperty( "java.version" );
	}
