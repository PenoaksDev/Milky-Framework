...
import com.chiorichan.command.defaults.ClearCommand;
import com.chiorichan.command.defaults.DefaultGameModeCommand;
import com.chiorichan.command.defaults.DeopCommand;
import com.chiorichan.command.defaults.DifficultyCommand;
import com.chiorichan.command.defaults.EffectCommand;
import com.chiorichan.command.defaults.EnchantCommand;
import com.chiorichan.command.defaults.ExpCommand;
import com.chiorichan.command.defaults.GameModeCommand;
import com.chiorichan.command.defaults.GameRuleCommand;
import com.chiorichan.command.defaults.GiveCommand;
import com.chiorichan.command.defaults.HelpCommand;
import com.chiorichan.command.defaults.KickCommand;
import com.chiorichan.command.defaults.KillCommand;
...
import com.chiorichan.command.defaults.ScoreboardCommand;
import com.chiorichan.command.defaults.SeedCommand;
import com.chiorichan.command.defaults.SpawnpointCommand;
import com.chiorichan.command.defaults.StopCommand;
import com.chiorichan.command.defaults.TeleportCommand;
import com.chiorichan.command.defaults.TellCommand;
import com.chiorichan.command.defaults.TestForCommand;
import com.chiorichan.command.defaults.TimeCommand;
import com.chiorichan.command.defaults.TimingsCommand;
import com.chiorichan.command.defaults.ToggleDownfallCommand;
import com.chiorichan.command.defaults.VanillaCommand;
import com.chiorichan.command.defaults.VersionCommand;
import com.chiorichan.command.defaults.WeatherCommand;
...
public class SimpleCommandMap implements CommandMap
{
	...
	private final ChioriFramework framework;
	...
	public SimpleCommandMap(final ChioriFramework framework)
	{
		this.framework = framework;
		setDefaultCommands( framework );
	}
	
	private void setDefaultCommands( final ChioriFramework framework )
	{
	...
	public void registerFrameworkAliases()
	{
		Map<String, String[]> values = framework.getCommandAliases();
		...
		for ( String alias : values.keySet() )
		{
			...
			if ( bad.length() > 0 )
			{
				framework.getLogger().warning( "The following command(s) could not be aliased under '" + alias + "' because they do not exist: " + bad );
			}
		}
	}
}
