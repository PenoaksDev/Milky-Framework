...
import com.chiorichan.EntityManager;
import com.chiorichan.IFramework;
import com.chiorichan.ServerConfig;
...
public abstract class JavaPlugin extends Plugin
{
	...
	private IFramework server = null;
	 ...
	 */
	protected final void initialize( PluginLoader loader, IFramework server, PluginDescriptionFile description, File dataFolder, File file, ClassLoader classLoader )
	{
		if ( !initialized )
		{
