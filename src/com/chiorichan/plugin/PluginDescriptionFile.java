...
public final class PluginDescriptionFile
{
	...
	/*
	 * public List<Permission> getPermissions() { if ( permissions == null ) { if ( lazyPermissions == null ) {
	 * permissions = ImmutableList.<Permission> of(); } else { permissions = ImmutableList.copyOf(
	 * Permission.loadPermissions( lazyPermissions, "Permission node '%s' in plugin description file for " +
	 * getFullName() + " is invalid", defaultPerm ) ); lazyPermissions = null; } } return permissions; }
	 * 
	 * public PermissionDefault getPermissionDefault() { return defaultPerm; }
	 */
