...
public interface FrameworkScheduler
{
	 ...
	 *            if task is null
	 */
	public FrameworkTask runTask( Plugin plugin, Runnable task ) throws IllegalArgumentException;
	 ...
	 *            if task is null
	 */
	public FrameworkTask runTaskAsynchronously( Plugin plugin, Runnable task ) throws IllegalArgumentException;
	 ...
	 *            if task is null
	 */
	public FrameworkTask runTaskLater( Plugin plugin, Runnable task, long delay ) throws IllegalArgumentException;
	 ...
	 *            if task is null
	 */
	public FrameworkTask runTaskLaterAsynchronously( Plugin plugin, Runnable task, long delay ) throws IllegalArgumentException;
	 ...
	 *            if task is null
	 */
	public FrameworkTask runTaskTimer( Plugin plugin, Runnable task, long delay, long period ) throws IllegalArgumentException;
	 ...
	 *            if task is null
	 */
	public FrameworkTask runTaskTimerAsynchronously( Plugin plugin, Runnable task, long delay, long period ) throws IllegalArgumentException;
}
