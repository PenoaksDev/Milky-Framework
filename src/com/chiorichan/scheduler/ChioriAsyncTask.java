...
class ChioriAsyncTask extends ChioriTask
{
	...
	private final LinkedList<FrameworkWorker> workers = new LinkedList<FrameworkWorker>();
	...
	public void run()
	{
		...
		synchronized ( workers )
		{
			...
			workers.add( new FrameworkWorker()
			{
		...
		finally
		{
			...
			synchronized ( workers )
			{
				try
				{
					final Iterator<FrameworkWorker> workers = this.workers.iterator();
	...
	LinkedList<FrameworkWorker> getWorkers()
	{
		return workers;
	}
