...
class Pipeline implements PipelineContract
{
	 ...
	 *
	 * @param  \Penoaks\Framework $framework
	 * @return void
	 */
		...
		return function ( $stack, $pipe )
		{
			return function ( $passable ) use ( $stack, $pipe )
			{
				if ( $pipe instanceof Closure )
				{
					...
					// otherwise we'll resolve the pipes out of the bindings and call it with
				...
				elseif ( !is_object( $pipe ) )
				{
					...
					// of the dependency injection bindings. We can then build a callable and
					// execute the pipe function giving in the parameters that are required.
					$pipe = $this->bindings->make( $name );
