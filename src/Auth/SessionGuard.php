...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
	 ...
	 *
	 * @param  string  $name
	 * @param  \Penoaks\Contracts\Auth\UserProvider  $provider
		...
		if (isset($this->events))
{
	 ...
	 *
	 * @param  \Penoaks\Contracts\Auth\Authenticatable|null  $user
	 * @param  array  $credentials
	 * @return void
	 */
		...
		if (empty($user->getRememberToken()))
{
	 ...
	 *
	 * @return \Penoaks\Contracts\Cookie\QueueingFactory
	 *
		...
		if (! isset($this->cookie))
{
	 ...
	 *
	 * @param  \Penoaks\Contracts\Cookie\QueueingFactory  $cookie
	 * @return void
	 */
