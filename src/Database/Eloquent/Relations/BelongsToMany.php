		...
		if (static::$constraints)
{
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Builder  $query
	 * @param  \Penoaks\Database\Eloquent\Builder  $parent
		...
		foreach (array_merge($defaults, $this->pivotColumns) as $column)
{
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Builder|null  $query
	 * @return $this
	 */
		...
		foreach ($models as $model)
{
	 ...
	 *
	 * @param  array   $models
	 * @param  \Penoaks\Database\Eloquent\Collection  $results
	 * @param  string  $relation
	 * @return array
	 */
		...
		if (count($ids) > 0)
{
	 ...
	 *
	 * @param  \Penoaks\Support\Collection|array  $models
		...
		foreach ($models as $key => $model)
{
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Penoaks\Database\Eloquent\Model|\Penoaks\Database\Eloquent\Collection|null
	 */
...
elseif (! is_null($result))
{
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Penoaks\Support\Collection|\Penoaks\Database\Eloquent\Model
	 */
		...
		foreach ($records as $key => $record)
{
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Collection|array  $ids
