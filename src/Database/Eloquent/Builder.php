...
class Builder
{
	 ...
	 *
	 * @var \Penoaks\Database\Query\Builder
	 */
	protected $query;
	 ...
	 *
	 * @var \Penoaks\Database\Eloquent\Model
	 */
	protected $model;
	 ...
	 * @param  \Penoaks\Database\Eloquent\Scope|\Closure  $scope
	 * @return $this
	 */
...
else
{
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Penoaks\Database\Eloquent\Model|\Penoaks\Database\Eloquent\Collection|static[]|static|null
	 */
		...
		if (empty($ids))
{
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Penoaks\Database\Eloquent\Model|\Penoaks\Database\Eloquent\Collection
	 *
	 * @throws \Penoaks\Database\Eloquent\ModelNotFoundException
	 */
		...
		if (! is_null($instance = $this->where($attributes)->first()))
{
	 ...
	 *
	 * @param  array  $columns
	 * @return \Penoaks\Database\Eloquent\Model|static|null
	 */
	 ...
	 *
	 * @param  array  $columns
	 * @return \Penoaks\Database\Eloquent\Model|static
	 *
	 * @throws \Penoaks\Database\Eloquent\ModelNotFoundException
	 */
			...
			foreach ($results as $key => &$value)
{
	 ...
	 * @param  int|null  $page
	 * @return \Penoaks\Contracts\Pagination\LengthAwarePaginator
	 *
	 ...
	 * @param  string  $pageName
	 * @param  int|null  $page
	 * @return \Penoaks\Contracts\Pagination\Paginator
	 */
			...
			if (strpos($name, '.') === false)
{
	 ...
	 *
	 * @param  string  $name
	 * @return \Penoaks\Database\Eloquent\Relations\Relation
	 */
...
else
{
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Builder  $hasQuery
	 * @param  \Penoaks\Database\Eloquent\Relations\Relation  $relation
	 * @param  string  $operator
	 * @param  int  $count
	 * @param  string  $boolean
	 * @return \Penoaks\Database\Eloquent\Builder|static
		...
		if (is_numeric($count))
{
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Builder  $relation
	 * @return \Penoaks\Database\Eloquent\Builder|static
	 */
...
{
					$scope->fwly($builder, $this->getModel());
				}
			});
		}
...
else
{
	 ...
	 *
	 * @return \Penoaks\Database\Query\Builder|static
	 */
	...
	{
		return $this->fwlyScopes()->getQuery();
	}
