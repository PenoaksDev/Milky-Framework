			...
			if (method_exists($class, $method = 'boot'.class_basename($trait)))
{
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Scope|\Closure|string  $scope
		...
		if ($scope instanceof Scope)
{
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Scope|string  $scope
	 * @return bool
	 */
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Scope|string  $scope
	 * @return \Penoaks\Database\Eloquent\Scope|\Closure|null
	 */
			...
			if (method_exists($class, $event))
{
	 ...
	 * @return $this
	 *
	 * @throws \Penoaks\Database\Eloquent\MassAssignmentException
	 */
		...
		if (count($this->getFillable()) > 0 && ! static::$unguarded)
{
	 ...
	 * @param  array  $items
	 * @param  string|null  $connection
	 * @return \Penoaks\Database\Eloquent\Collection
	 */
		...
		return static::unguarded(function () use ($model, $attributes)
{
	 ...
	 *
	 * @return \Penoaks\Database\Eloquent\Builder
	 */
	 ...
	 * @return \Penoaks\Database\Eloquent\Collection|static[]
	 */
		...
		if (is_string($relations))
{
	 ...
	 *
	 * @param  array|string  $relations
	 * @return \Penoaks\Database\Eloquent\Builder|static
	 */
		...
		if (is_string($attributes))
{
		...
		$this->fwends = array_unique(
			array_merge($this->fwends, $attributes)
		);
	 ...
	 * @return \Penoaks\Database\Eloquent\Relations\HasOne
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \Penoaks\Database\Eloquent\Relations\MorphOne
	 */
	 ...
	 * @return \Penoaks\Database\Eloquent\Relations\BelongsTo
	 */
		...
		if (is_null($foreignKey))
{
	 ...
	 * @param  string  $type
	 * @param  string  $id
	 * @return \Penoaks\Database\Eloquent\Relations\MorphTo
	 */
		...
		else
{
	 ...
	 * @param  string  $foreignKey
	 * @param  string  $localKey
	 * @return \Penoaks\Database\Eloquent\Relations\HasMany
	 */
	 ...
	 * @return \Penoaks\Database\Eloquent\Relations\HasManyThrough
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \Penoaks\Database\Eloquent\Relations\MorphMany
	 */
	 ...
	 * @param  string  $otherKey
	 * @param  string  $relation
	 * @return \Penoaks\Database\Eloquent\Relations\BelongsToMany
	 */
		...
		if (is_null($table))
{
	 ...
	 * @param  string  $otherKey
	 * @param  bool  $inverse
	 * @return \Penoaks\Database\Eloquent\Relations\MorphToMany
	 */
		...
		if (Arr::get($options, 'touch', true))
{
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Builder  $query
	 * @param  array  $options
	 * @return bool
	 */
		...
		foreach ($this->getGlobalScopes() as $identifier => $scope)
{
	 ...
	 *
	 * @param  \Penoaks\Database\Eloquent\Model  $parent
	 * @param  array  $attributes
	 * @param  string  $table
	 * @param  bool  $exists
	 * @return \Penoaks\Database\Eloquent\Relations\Pivot
	 */
		...
		if (! empty($this->visible))
{
	 ...
	 * @return $this
	 */
	public function setAppends(array $fwends)
	{
		$this->fwends = $fwends;
		...
		foreach ($this->getArrayableAppends() as $key)
{
	...
	{
		if (! count($this->fwends))
{
			return [];
		}

		return $this->getArrayableItems(
			array_combine($this->fwends, $this->fwends)
		);
	}
		...
		if (! $relations instanceof Relation)
{
			throw new LogicException('Relationship method must return an object of type '
				.'Penoaks\Database\Eloquent\Relations\Relation');
		}
		...
		if (preg_match('/^(\d{4})-(\d{1,2})-(\d{1,2})$/', $value))
{
	 ...
	 * @return \Penoaks\Database\Eloquent\Model
	 */
								 ...
								 ! $this->originalIsNumericallyEquivalent($key))
{
	 ...
	 *
	 * @return \Penoaks\Database\ConnectionResolverInterface
	 */
