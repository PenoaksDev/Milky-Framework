	...
	use Macroable
{
	 ...
	 *
	 * @var \Penoaks\Database\Query\Grammars\Grammar
	 */
	protected $grammar;
	 ...
	 *
	 * @var \Penoaks\Database\Query\Processors\Processor
	 */
	protected $processor;
	 ...
	 * @param  \Penoaks\Database\Query\Grammars\Grammar  $grammar
	 * @param  \Penoaks\Database\Query\Processors\Processor  $processor
	 * @return void
	 */
		...
		if ($bindings)
{
	 ...
	 *
	 * @param  \Closure|\Penoaks\Database\Query\Builder|string $query
	 * @param  string  $as
	 * @return \Penoaks\Database\Query\Builder|static
	 *
			...
			! in_array(strtolower($operator), $this->grammar->getOperators(), true))
{
	 ...
	 *
	 * @param  \Penoaks\Database\Query\Builder|static $query
	 * @param  string  $boolean
	 * @return $this
	 */
				...
				->reject(function ($order) use ($column)
{
	 ...
	 *
	 * @param  \Penoaks\Database\Query\Builder|\Closure  $query
	 * @param  bool  $all
	 * @return \Penoaks\Database\Query\Builder|static
	 */
		...
		return array_values(array_filter($bindings, function ($binding)
{
	 ...
	 *
	 * @param  mixed  $value
	 * @return \Penoaks\Database\Query\Expression
	 */
...
else
{
	 ...
	 *
	 * @return \Penoaks\Database\ConnectionInterface
	 */
	 ...
	 *
	 * @return \Penoaks\Database\Query\Processors\Processor
	 */
	 ...
	 *
	 * @return \Penoaks\Database\Query\Grammars\Grammar
	 */
