...
abstract class Grammar extends BaseGrammar
{
	 ...
	 *
	 * @param  \Penoaks\Database\Schema\Blueprint  $blueprint
	 * @param  \Penoaks\Support\Fluent  $command
		...
		foreach ($blueprint->getAddedColumns() as $column)
{
	 ...
	 * @param  string  $sql
	 * @param  \Penoaks\Database\Schema\Blueprint  $blueprint
	 * @param  \Penoaks\Support\Fluent  $column
	 * @return string
	 */
			...
			if (method_exists($this, $method = "modify{$modifier}"))
{
	 ...
	 * @param  \Penoaks\Database\Schema\Blueprint  $blueprint
	 * @param  string  $name
	 * @return \Penoaks\Support\Fluent|null
	 */
		...
		foreach ($blueprint->getChangedColumns() as $fluent)
{
			...
			// Doctrine column definitions - which is necessary because Framework and Doctrine
					...
					if (method_exists($column, $method = 'set'.ucfirst($option)))
{
	 ...
	 *
	 * @param  \Doctrine\DBAL\Schema\Table  $table
	 * @param  \Penoaks\Support\Fluent  $fluent
