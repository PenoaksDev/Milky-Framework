...
class Validator implements ValidatorContract
{
	 ...
	 *
	 * @var \Penoaks\Validation\PresenceVerifierInterface
	 */
	 ...
	 *
	 * @var \Penoaks\Support\MessageBag
	 */
	protected $messages;
		...
		return array_map(function ($field) use ($keys)
{
	...
	public function addExtensions(array $extensions)
	{
		if ($extensions)
{
			$keys = array_map('\Penoaks\Support\Str::snake', array_keys($extensions));
		...
		foreach ($extensions as $rule => $extension)
{
	...
	public function addReplacers(array $replacers)
	{
		if ($replacers)
{
			$keys = array_map('\Penoaks\Support\Str::snake', array_keys($replacers));
	 ...
	 *
	 * @return \Penoaks\Validation\PresenceVerifierInterface
	 *
		...
		if (! isset($this->presenceVerifier))
{
	 ...
	 *
	 * @param  \Penoaks\Validation\PresenceVerifierInterface  $presenceVerifier
	 * @return void
	 */
