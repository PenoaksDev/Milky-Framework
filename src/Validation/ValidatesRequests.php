...
trait ValidatesRequests
{
	 ...
	 *
	 * @param  \Penoaks\Contracts\Validation\Validator|array  $validator
	 * @param  \Penoaks\Http\Request|null  $request
	 * @return void
	 */
		...
		if ($validator->fails())
{
	 ...
	 * @return void
	 *
	 * @throws \Penoaks\Validation\ValidationException
	 */
		...
		if (($request->ajax() && ! $request->pjax()) || $request->wantsJson())
{
	 ...
	 *
	 * @return \Penoaks\Contracts\Validation\Factory
	 */
