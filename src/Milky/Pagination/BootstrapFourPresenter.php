...
use Milky\Support\HtmlString;
use Milky\Pagination\Paginator as PaginatorContract;
use Milky\Pagination\Presenter as PresenterContract;
...
class BootstrapFourPresenter implements PresenterContract
{
	 ...
	 *
	 * @var \Milky\Pagination\Paginator
	 */
	protected $paginator;
	 ...
	 *
	 * @param  \Milky\Pagination\Paginator  $paginator
	 * @param  \Milky\Pagination\UrlWindow|null  $window
	 * @return void
	 */
