...
use Milky\Database\Eloquent\Relations\HasManyThrough;
use Milky\Database\Eloquent\Relations\HasOne;
use Milky\Database\Eloquent\Relations\MorphMany;
use Milky\Database\Eloquent\Relations\MorphOne;
use Milky\Database\Eloquent\Relations\MorphTo;
use Milky\Database\Eloquent\Relations\MorphToMany;
use Milky\Database\Eloquent\Relations\Pivot;
use Milky\Database\Eloquent\Relations\Relation;
use Milky\Database\Query\Builder as QueryBuilder;
use Milky\Helpers\Arr;
use Milky\Helpers\Str;
use Milky\Http\Routing\UrlRoutable;
 ...
 * Class Model
 *
 * @package Milky\Database\Eloquent
 *
...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, UrlRoutable
{
	...
	protected function getRelationshipFromMethod( $method )
	{
		...
		if ( !$relations instanceof Relation )
			throw new LogicException( 'Relationship method must return an object of type ' . 'Milky\Database\Eloquent\Relations\Relation' );
