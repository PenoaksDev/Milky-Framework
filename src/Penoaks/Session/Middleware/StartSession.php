...
class StartSession
{
	 ...
	 * The session manager.
	 *
	 * @var \Penoaks\Session\SessionManager
	 */
	protected $manager;
	 ...
	 *
	 * @param  \Penoaks\Session\SessionManager  $manager
	 * @return void
	 */
		...
		if ($this->sessionHandled && $this->sessionConfigured() && ! $this->usingCookieSessions())
{
	 ...
	 *
	 * @param  \Penoaks\Http\Request  $request
	 * @return \Penoaks\Session\SessionInterface
	 */
	 ...
	 *
	 * @param  \Penoaks\Http\Request  $request
	 * @param  \Penoaks\Session\SessionInterface  $session
	 * @return void
	 */
