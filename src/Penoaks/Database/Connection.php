...
class Connection implements ConnectionInterface
{
	 ...
	 *
	 * @var \Penoaks\Database\Schema\Grammars\Grammar
	 */
	 ...
	 *
	 * @return \Penoaks\Database\Schema\Grammars\Grammar
	 */
...
elseif ($this->transactions > 1 && $this->queryGrammar->supportsSavepoints())
{
	 ...
	 * @return mixed
	 *
	 * @throws \Penoaks\Database\QueryException
	 */
		...
		catch (Exception $e)
{
	 ...
	 *
	 * @param  \Penoaks\Database\QueryException  $e
	 * @param  string	$query
	 * @param  array	 $bindings
	 * @param  \Closure  $callback
	 * @return mixed
		...
		if ($this->transactions >= 1)
{
	 ...
	 *
	 * @param  \Penoaks\Database\Schema\Grammars\Grammar  $grammar
	 * @return void
	 */
	 ...
	 *
	 * @param  \Penoaks\Database\Grammar  $grammar
	 * @return \Penoaks\Database\Grammar
	 */
