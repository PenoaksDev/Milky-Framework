...
class Worker
{
	 ...
	 *
	 * @var \Penoaks\Queue\Failed\FailedJobProviderInterface
	 */
	protected $failer;
	 ...
	 *
	 * @var \Penoaks\Contracts\Cache\Repository
	 */
	protected $cache;
	 ...
	 *
	 * @var \Penoaks\Exceptions\Handler
	 */
	 ...
	 * @param  \Penoaks\Queue\Failed\FailedJobProviderInterface  $failer
			...
			if ($this->exceptions)
{
	 ...
	 *
	 * @param  \Penoaks\Contracts\Queue\Queue  $connection
	 * @param  string  $queue
		...
		if ($this->cache)
{
	 ...
	 *
	 * @param  \Penoaks\Contracts\Debug\ExceptionHandler  $handler
	 * @return void
	 */
	 ...
	 *
	 * @param  \Penoaks\Contracts\Cache\Repository  $cache
	 * @return void
	 */
