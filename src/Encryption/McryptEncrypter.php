...
/**
 * @deprecated since version 5.1. Use Penoaks\Encryption\Encrypter.
 */
...
else
{
	 ...
	 * @return string
	 *
	 * @throws \Penoaks\Contracts\Encryption\EncryptException
	 */
		...
		if (! is_string($json))
{
	 ...
	 * @return string
	 *
	 * @throws \Penoaks\Contracts\Encryption\DecryptException
	 */
