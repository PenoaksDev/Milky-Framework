...
class View implements ArrayAccess, ViewContract
{
	 ...
	 *
	 * @var \Penoaks\View\Engines\EngineInterface
	 */
	protected $engine;
	 ...
	 *
	 * @param  \Penoaks\View\Factory $factory
	 * @param  \Penoaks\View\Engines\EngineInterface $engine
	 * @param  string $view
	 * @param  string $path
	 * @param  mixed $data
	 * @return void
	 ...
	 *
	 * @param  \Penoaks\Contracts\Support\MessageProvider|array $provider
	 * @return $this
	 */
