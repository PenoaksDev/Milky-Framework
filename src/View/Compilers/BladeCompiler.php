		...
		$callback = function ($matches)
{
	...
	{
		return "<?php if (app('Penoaks\\Contracts\\Auth\\Access\\Gate')->check{$expression}): ?>";
	}
	...
	{
		return "<?php elseif (app('Penoaks\\Contracts\\Auth\\Access\\Gate')->check{$expression}): ?>";
	}
	...
	{
		return "<?php if (app('Penoaks\\Contracts\\Auth\\Access\\Gate')->denies{$expression}): ?>";
	}
	...
	{
		return "<?php elseif (app('Penoaks\\Contracts\\Auth\\Access\\Gate')->denies{$expression}): ?>";
	}
