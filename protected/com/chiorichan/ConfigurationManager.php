<?php
	...
	class ConfigurationManager
	{
		...
		public function getConfig( string $keyName, $arg2 = null, $arg3 = CONFIG_SITE )
		{
			$default = null;
		...
		public function keyExists( string $keyName, $arg2 = CONFIG_SITE )
		{
			$path = explode(".", $keyName);
		...
		public function getString( string $keyName, $arg2 = null, $arg3 = CONFIG_SITE )
		{
			return (string) $this->getConfig( $keyName, $arg2, $arg3 );
		}
		
		public function getArray( string $keyName, $arg2 = null, $arg3 = CONFIG_SITE )
		{
			return (array) $this->getConfig( $keyName, $arg2, $arg3 );
		}
		
		public function getBoolean( string $keyName, $arg2 = null, $arg3 = CONFIG_SITE )
		{
			return (boolean) $this->getConfig( $keyName, $arg2, $arg3 );
		}
		
		public function getInt( string $keyName, $arg2 = null, $arg3 = CONFIG_SITE )
		{
