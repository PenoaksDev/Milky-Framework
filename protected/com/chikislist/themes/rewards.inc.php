...
<script type="text/javascript">
	...
	function showWarning(caption, func)
	{
		...
		if (typeof(func) == "function")
		{
			$("#warningDialog").bind("dialogclose", func)
		}
		else
		{
			$("#warningDialog").unbind("dialogclose")
		}
...
//		alert(caption && "" != caption ? icon + caption : icon + "An error occured. Try again.");
	...
	function loadNew(page, self)
	{
		...
		page = "http://rewards.chikislist.com/ajax/" + page;
