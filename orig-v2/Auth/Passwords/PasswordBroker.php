...
class PasswordBroker implements PasswordBrokerContract
{
	 ...
	 *
	 * @var \Penoaks\Auth\Passwords\TokenRepositoryInterface
	 */
	protected $tokens;
	 ...
	 * The mailer instance.
	 *
	 * @var \Penoaks\Contracts\Mail\Mailer
	 */
	protected $mailer;
	 ...
	 *
	 * @param  \Penoaks\Auth\Passwords\TokenRepositoryInterface  $tokens
	 * @param  \Penoaks\Contracts\Auth\UserProvider  $users
	 * @param  \Penoaks\Contracts\Mail\Mailer  $mailer
		...
		if (! $user instanceof CanResetPasswordContract)
{
	 ...
	 *
	 * @param  array  $credentials
	 * @return \Penoaks\Contracts\Auth\CanResetPassword
	 */
		...
		if ($user && ! $user instanceof CanResetPasswordContract)
{
	 ...
	 *
	 * @return \Penoaks\Auth\Passwords\TokenRepositoryInterface
	 */
