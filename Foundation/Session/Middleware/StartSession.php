...
namespace Foundation\Session\Middleware;
...
class StartSession
{
	 ...
	 * The session manager.
	 *
	 * @var \Foundation\Session\SessionManager
	 */
	protected $manager;
	 ...
	 *
	 * @param  \Foundation\Session\SessionManager  $manager
	 * @return void
	 */
		...
		if ($this->sessionHandled && $this->sessionConfigured() && ! $this->usingCookieSessions())
{
	 ...
	 *
	 * @param  \Foundation\Http\Request  $request
	 * @return \Foundation\Session\SessionInterface
	 */
	 ...
	 *
	 * @param  \Foundation\Http\Request  $request
	 * @param  \Foundation\Session\SessionInterface  $session
	 * @return void
	 */
