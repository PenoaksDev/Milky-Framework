...
namespace Foundation\Encryption;
...
/**
 * @deprecated since version 5.1. Use Foundation\Encryption\Encrypter.
 */
class McryptEncrypter extends BaseEncrypter implements EncrypterContract
{
	 ...
	 * @return string
	 *
	 * @throws \Foundation\Contracts\Encryption\EncryptException
	 */
	 ...
	 * @return string
	 *
	 * @throws \Foundation\Contracts\Encryption\DecryptException
	 */
