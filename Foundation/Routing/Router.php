...
class Router implements RegistrarContract
{
	...
	{
		if ($this->container && $this->container->bound('Foundation\Routing\ResourceRegistrar')) {
			$registrar = $this->container->make('Foundation\Routing\ResourceRegistrar');
		} else {
	...
	protected function findRoute($request)
	{
		...
		$this->container->instance('Foundation\Routing\Route', $route);
