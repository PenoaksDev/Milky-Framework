...
namespace Foundation\View\Compilers;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
	...
	{
		return "<?php if (app('Foundation\\Contracts\\Auth\\Access\\Gate')->check{$expression}): ?>";
	}
	...
	{
		return "<?php elseif (app('Foundation\\Contracts\\Auth\\Access\\Gate')->check{$expression}): ?>";
	}
	...
	{
		return "<?php if (app('Foundation\\Contracts\\Auth\\Access\\Gate')->denies{$expression}): ?>";
	}
	...
	{
		return "<?php elseif (app('Foundation\\Contracts\\Auth\\Access\\Gate')->denies{$expression}): ?>";
	}
