...
class Builder
{
	 ...
	 *
	 * @var \Foundation\Database\Connection
	 */
	 ...
	 *
	 * @param  \Closure|\Foundation\Database\Query\Builder|string $query
	 * @param  string  $as
	 * @return \Foundation\Database\Query\Builder|static
	 *
	 ...
	 *
	 * @param  \Foundation\Database\Query\Builder|static $query
	 * @param  string  $boolean
	 * @return $this
	 */
	 ...
	 *
	 * @param  \Foundation\Database\Query\Builder|\Closure  $query
	 * @param  bool  $all
	 * @return \Foundation\Database\Query\Builder|static
	 */
