...
class Builder
{
	 ...
	 *
	 * @var \Foundation\Database\Query\Builder
	 */
	protected $query;
	 ...
	 * @param  \Foundation\Database\Eloquent\Scope|\Closure  $scope
	 * @return $this
	 */
...
else
{
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Foundation\Database\Eloquent\Model|\Foundation\Database\Eloquent\Collection|static[]|static|null
	 */
		...
		if (empty($ids))
{
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Foundation\Database\Eloquent\Model|\Foundation\Database\Eloquent\Collection
	 *
	 * @throws \Foundation\Database\Eloquent\ModelNotFoundException
	 */
		...
		if (! is_null($instance = $this->where($attributes)->first()))
{
	 ...
	 *
	 * @param  array  $columns
	 * @return \Foundation\Database\Eloquent\Model|static|null
	 */
	 ...
	 *
	 * @param  array  $columns
	 * @return \Foundation\Database\Eloquent\Model|static
	 *
	 * @throws \Foundation\Database\Eloquent\ModelNotFoundException
	 */
			...
			foreach ($results as $key => &$value)
{
	 ...
	 * @param  int|null  $page
	 * @return \Foundation\Contracts\Pagination\LengthAwarePaginator
	 *
	 ...
	 * @param  string  $pageName
	 * @param  int|null  $page
	 * @return \Foundation\Contracts\Pagination\Paginator
	 */
			...
			if (strpos($name, '.') === false)
{
	 ...
	 *
	 * @param  string  $name
	 * @return \Foundation\Database\Eloquent\Relations\Relation
	 */
...
else
{
	 ...
	 *
	 * @param  \Foundation\Database\Eloquent\Builder  $hasQuery
	 * @param  \Foundation\Database\Eloquent\Relations\Relation  $relation
	 * @param  string  $operator
	 * @param  int  $count
	 * @param  string  $boolean
	 * @return \Foundation\Database\Eloquent\Builder|static
		...
		if (is_numeric($count))
{
	 ...
	 *
	 * @param  \Foundation\Database\Eloquent\Builder  $relation
	 * @return \Foundation\Database\Eloquent\Builder|static
	 */
...
else
{
	 ...
	 *
	 * @return \Foundation\Database\Query\Builder|static
	 */
