			...
			if (method_exists($class, $method = 'boot'.class_basename($trait)))
{
	 ...
	 *
	 * @param  \Foundation\Database\Eloquent\Scope|\Closure|string  $scope
		...
		if ($scope instanceof Scope)
{
	 ...
	 *
	 * @param  \Foundation\Database\Eloquent\Scope|string  $scope
	 * @return bool
	 */
	 ...
	 *
	 * @param  \Foundation\Database\Eloquent\Scope|string  $scope
	 * @return \Foundation\Database\Eloquent\Scope|\Closure|null
	 */
			...
			if (method_exists($class, $event))
{
	 ...
	 * @return $this
	 *
	 * @throws \Foundation\Database\Eloquent\MassAssignmentException
	 */
		...
		if (count($this->getFillable()) > 0 && ! static::$unguarded)
{
	 ...
	 * @param  array  $items
	 * @param  string|null  $connection
	 * @return \Foundation\Database\Eloquent\Collection
	 */
		...
		return static::unguarded(function () use ($model, $attributes)
{
	 ...
	 * @return \Foundation\Database\Eloquent\Collection|static[]
	 */
		...
		if (is_string($relations))
{
	 ...
	 *
	 * @param  array|string  $relations
	 * @return \Foundation\Database\Eloquent\Builder|static
	 */
		...
		if (is_string($attributes))
{
	 ...
	 * @return \Foundation\Database\Eloquent\Relations\HasOne
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \Foundation\Database\Eloquent\Relations\MorphOne
	 */
		...
		if (is_null($foreignKey))
{
	 ...
	 * @param  string  $type
	 * @param  string  $id
	 * @return \Foundation\Database\Eloquent\Relations\MorphTo
	 */
		...
		else
{
	 ...
	 * @param  string  $foreignKey
	 * @param  string  $localKey
	 * @return \Foundation\Database\Eloquent\Relations\HasMany
	 */
	 ...
	 * @return \Foundation\Database\Eloquent\Relations\HasManyThrough
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \Foundation\Database\Eloquent\Relations\MorphMany
	 */
	 ...
	 * @param  string  $otherKey
	 * @param  string  $relation
	 * @return \Foundation\Database\Eloquent\Relations\BelongsToMany
	 */
		...
		if (is_null($table))
{
	 ...
	 * @param  string  $otherKey
	 * @param  bool  $inverse
	 * @return \Foundation\Database\Eloquent\Relations\MorphToMany
	 */
		...
		if (! $relations instanceof Relation)
{
			throw new LogicException('Relationship method must return an object of type '
				.'Foundation\Database\Eloquent\Relations\Relation');
		}
								 ...
								 ! $this->originalIsNumericallyEquivalent($key))
{
	 ...
	 *
	 * @return \Foundation\Database\ConnectionResolverInterface
	 */
	 ...
	 *
	 * @param  \Foundation\Database\ConnectionResolverInterface  $resolver
	 * @return void
	 */
	 ...
	 *
	 * @return \Foundation\Contracts\Events\Dispatcher
	 */
