...
namespace Foundation\Translation;
...
class Translator extends NamespacedItemResolver implements TranslatorInterface
{
	 ...
	 *
	 * @var \Foundation\Translation\LoaderInterface
	 */
	protected $loader;
	 ...
	 *
	 * @param  \Foundation\Translation\LoaderInterface  $loader
	 * @param  string  $locale
	 * @return void
	 */
	 ...
	 *
	 * @return \Foundation\Translation\LoaderInterface
	 */
