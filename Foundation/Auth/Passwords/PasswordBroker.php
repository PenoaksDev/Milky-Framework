...
class PasswordBroker implements PasswordBrokerContract
{
	 ...
	 *
	 * @var \Foundation\Auth\Passwords\TokenRepositoryInterface
	 */
	protected $tokens;
	 ...
	 *
	 * @var \Foundation\Contracts\Auth\UserProvider
	 */
	protected $users;
	 ...
	 * The mailer instance.
	 *
	 * @var \Foundation\Contracts\Mail\Mailer
	 */
	protected $mailer;
	 ...
	 *
	 * @param  \Foundation\Auth\Passwords\TokenRepositoryInterface  $tokens
	 * @param  \Foundation\Contracts\Auth\UserProvider  $users
	 * @param  \Foundation\Contracts\Mail\Mailer  $mailer
		...
		if (is_null($user))
{
	 ...
	 *
	 * @param  \Foundation\Contracts\Auth\CanResetPassword  $user
	 * @param  string  $token
	 * @param  \Closure|null  $callback
	 * @return int
	 */
		...
		if (! $user instanceof CanResetPasswordContract)
{
	 ...
	 *
	 * @param  array  $credentials
	 * @return \Foundation\Contracts\Auth\CanResetPassword
	 */
