...
use Foundation\Contracts\Foundation\Application as ApplicationContract;

/**
 * @Product: Chiori-chan Framework API
 ...
 */
class Constructor extends Container implements ApplicationContract, HttpKernelInterface
{
	/**
	...
	protected function registerBaseBindings()
	{
		...
		$this->instance('Foundation\Container\Container', $this);
	}
	...
	public function afterLoadingEnvironment(Closure $callback)
	{
		return $this->afterBootstrapping(
			'Foundation\Bootstrap\DetectEnvironment', $callback
		);
	}
	...
	{
		return $this['Foundation\Contracts\Http\Kernel']->handle(Request::createFromBase($request));
	}
	...
	{
		$aliases = [
			'app'				  => ['Foundation\Application', 'Foundation\Contracts\Container\Container', 'Foundation\Contracts\Foundation\Application'],
			...
			'cookie'			   => ['Foundation\Cookie\CookieJar', 'Foundation\Contracts\Cookie\Factory', 'Foundation\Contracts\Cookie\QueueingFactory'],
			...
			'mailer'			   => ['Foundation\Mail\Mailer', 'Foundation\Contracts\Mail\Mailer', 'Foundation\Contracts\Mail\MailQueue'],
			'auth.password'		=> ['Foundation\Auth\Passwords\PasswordBrokerManager', 'Foundation\Contracts\Auth\PasswordBrokerFactory'],
			'auth.password.broker' => ['Foundation\Auth\Passwords\PasswordBroker', 'Foundation\Contracts\Auth\PasswordBroker'],
			'queue'				=> ['Foundation\Queue\QueueManager', 'Foundation\Contracts\Queue\Factory', 'Foundation\Contracts\Queue\Monitor'],
			...
			'session.store'		=> ['Foundation\Session\Store', 'Symfony\Component\HttpFoundation\Session\SessionInterface'],
	...
	{
		$kernel = $this->make( \Foundation\Contracts\Http\Kernel::class );

		$response = $kernel->handle(
			$request = \Foundation\Http\Request::capture()
		);
